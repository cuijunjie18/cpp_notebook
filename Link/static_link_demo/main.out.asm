...
0000000000001149 <main>:
    ...
    1155:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%rbp)
    115c:	c7 45 f8 14 00 00 00 	movl   $0x14,-0x8(%rbp)
    1163:	8b 55 f8             	mov    -0x8(%rbp),%edx
    1166:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1169:	89 d6                	mov    %edx,%esi
    116b:	89 c7                	mov    %eax,%edi
    116d:	e8 23 00 00 00       	call   1195 <_Z3sumii>
...
0000000000001195 <_Z3sumii>:
    1195:	f3 0f 1e fa          	endbr64 
    1199:	55                   	push   %rbp
    119a:	48 89 e5             	mov    %rsp,%rbp
    119d:	89 7d fc             	mov    %edi,-0x4(%rbp)
    11a0:	89 75 f8             	mov    %esi,-0x8(%rbp)
    11a3:	8b 55 fc             	mov    -0x4(%rbp),%edx
    11a6:	8b 45 f8             	mov    -0x8(%rbp),%eax
